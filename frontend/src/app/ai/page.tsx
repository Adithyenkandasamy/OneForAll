        ...
        try {
            ...
            setChatMessages((prev) => [
                ...prev,
                {
                    ...
                    role: "ai",
                    content: data.analysis || data.message || data.content || "Request processed through Central Agent routing.",
                }
            ]);
            ...
            setChatMessages((prev) => [
                ...prev,
                {
                    ...
                    content: err.response?.status === 403
                        ? "Access Denied: You do not have permission to execute this internal orchestration tool."
                        : "An error occurred while communicating with the central intelligence service."
                }
            ]);
        } finally {
                    ...
                    <CardFooter className="p-4 border-t border-border/50 bg-background/50">
                        <form onSubmit={handleChatSubmit} className="flex w-full gap-3 relative">
                            ...
                            <Button
                                type="submit"
                                size="icon"
                                className="absolute right-1.5 top-1.5 h-9 w-9 bg-indigo-500 hover:bg-indigo-600 rounded-lg shadow-sm"
